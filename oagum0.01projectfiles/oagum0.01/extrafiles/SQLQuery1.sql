...
where Title like '%An anthology of%';

insert into dbo.T_ArticleSmallMeDa_02 (KeyTitle,Title,PubDate,Link) 
select distinct SUBSTRING(x.Title,0,39),x.Title,x.PubDate,x.Relation 
